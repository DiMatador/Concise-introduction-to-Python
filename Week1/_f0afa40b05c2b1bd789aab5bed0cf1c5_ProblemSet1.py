...
def problem1_4(miles):
    ...
    print("There are",miles_to_feet,"feet in",miles,"miles.")
...
def problem1_6():
    for i in range(1,100,2):
            print(i,end=' ')
    #count all even numbers from 2-100
...
def problem1_7():
    ...
    print("The area of a trapezoid with bases",b1,"and",b2,"and height",h,"is",area1,)
#%%
"""
